...
namespace EmissorPedidos.Migrations
{
    ...
    [Migration("20190113020008_Usuario_NivelUsuario")]
    partial class Usuario_NivelUsuario
    {
            ...
            modelBuilder.Entity("EmissorPedidos.Models.Usuarios", b =>
                {
                    ...
                    b.Property<int?>("NivelUsuarioIdNivelUsuario");

                    b.Property<string>("Nome");

                    b.HasKey("IdUsuario");

                    b.HasIndex("NivelUsuarioIdNivelUsuario");
            ...
            modelBuilder.Entity("EmissorPedidos.Models.Usuarios", b =>
                {
                    b.HasOne("EmissorPedidos.Models.NivelUsuario", "NivelUsuario")
                        .WithMany("Usuarios")
                        .HasForeignKey("NivelUsuarioIdNivelUsuario");
                });
